...
public class HandshakeCalculatorTest {
    ...
    @Test
    public void testThatInput5YieldsTwoActions() {
    	assertThat(handshakeCalculator.calculateHandshake(5)).containsExactly(Signal.WINK, Signal.CLOSE_YOUR_EYES);
    }
    
    @Test
    public void testThatInput6YieldsTwoActions() {
    	assertThat(handshakeCalculator.calculateHandshake(6)).containsExactly(Signal.DOUBLE_BLINK, Signal.CLOSE_YOUR_EYES);
    }

    @Test
    public void testThatInput7YieldsThreeActions() {
    	assertThat(handshakeCalculator.calculateHandshake(7)).containsExactly(Signal.WINK, Signal.DOUBLE_BLINK, Signal.CLOSE_YOUR_EYES);
    }
    //@Ignore("Remove to run test")
    @Test
    ...
    @Test
    public void testThatInput9YieldsTwoActions() {
    	assertThat(handshakeCalculator.calculateHandshake(9)).containsExactly(Signal.WINK, Signal.JUMP);
    }
    
    @Test
    public void testThatInput10YieldsTwoActions() {
    	assertThat(handshakeCalculator.calculateHandshake(10)).containsExactly(Signal.DOUBLE_BLINK, Signal.JUMP);
    }
    
    @Test
    public void testThatInput11YieldsThreeActions() {
    	assertThat(handshakeCalculator.calculateHandshake(11)).containsExactly(Signal.WINK, Signal.DOUBLE_BLINK, Signal.JUMP);
    }

    @Test
    public void testThatInput12YieldsTwoActions() {
    	assertThat(handshakeCalculator.calculateHandshake(12)).containsExactly(Signal.CLOSE_YOUR_EYES, Signal.JUMP);
    }
    //@Ignore("Remove to run test")
    @Test
